...
public final class CoinReceptacle extends AbstractHardware<CoinReceptacleListener> implements
	...
	notifyListeners(CoinReceptacleListener.class, "load", parameterTypes, args);
    }

    private void notifyUnload(List<Coin> coins) {
	Class<?>[] parameterTypes = new Class<?>[] { CoinReceptacle.class, List.class };
	Object[] args = new Object[] { this, coins };
	notifyListeners(CoinReceptacleListener.class, "unload", parameterTypes, args);
    }
}
